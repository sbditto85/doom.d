...
#+begin_src elisp :tangle yes
(defun custom/evil-next-5-lines ()
  (interactive)
  (evil-next-line 5)
  )

(defun custom/evil-previous-5-lines ()
  (interactive)
  (evil-previous-line 5)
  )

(map! :desc "Five lines down" :n "M-j" #'custom/evil-next-5-lines)
(map! :desc "Five lines down" :i "M-j" #'custom/evil-next-5-lines)
(map! :desc "Five lines up" :n "M-k" #'custom/evil-previous-5-lines)
(map! :desc "Five lines up" :i "M-k" #'custom/evil-previous-5-lines)
...
(add-hook 'treemacs-mode-hook
          (lambda ()
            (local-set-key (kbd "M-j") #'custom/evil-next-5-lines)
            (local-set-key (kbd "M-k") #'custom/evil-previous-5-lines)))
